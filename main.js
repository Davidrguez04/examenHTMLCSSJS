...
function listadoPrestamos() {
    ...
    const listadoPrestamos = listaPrestamos();
    const prestamos = document.querySelector('#prestamos');
    prestamos.listaPrestamos = '';
    prestamos.append(listadoPrestamos);
    document.append(imgPrestamos());

}

function listadoSocios() {
    const listadoSocios = listaSocios();
    const socios = document.querySelector('#socios');
    socios.listaSocios = '';
    socios.append(listadoSocios);
    document.append(imgSocios());
